...
exports.BinanceWallet = exports.NoBinanceWalletError = void 0;
const types_1 = require("@web3-react/types");
class NoBinanceWalletError extends Error {
    constructor() {
        super('BinanceWallet not installed');
        this.name = NoBinanceWalletError.name;
        Object.setPrototypeOf(this, NoBinanceWalletError.prototype);
    }
}
exports.NoBinanceWalletError = NoBinanceWalletError;
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return (this.eagerConnection = Promise.resolve().then(() => __importStar(require('./detectEthereumProvider'))).then((m) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (provider) {
                    ...
                    // handle the case when e.g. Binancewallet and metamask wallet are both installed
                    if ((_a = this.provider.providers) === null || _a === void 0 ? void 0 : _a.length) {
                        this.provider = (_b = this.provider.providers.find((p) => p.isBinanceWallet)) !== null && _b !== void 0 ? _b : this.provider.providers[0];
                    }
                    ...
                    this.provider.on('disconnect', (error) => {
                        ...
                        if ((error === null || error === void 0 ? void 0 : error.code) === 1013) {
                            console.debug('BinanceWallet logged connection error 1013: "Try again later"');
                            return;
                        }
    ...
    connectEagerly() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                // we should be able to use `cancelActivation` here, but on mobile, BinanceWallet emits a 'connect'
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this.isomorphicInitialize()
                ...
                if (!this.provider) {
                    ...
                    throw new NoBinanceWalletError();
                }
                // Wallets may resolve eth_chainId and hang on eth_accounts pending user interaction, which may include changing
                // chains; they should be requested serially, with accounts first, so that the chainId can settle.
